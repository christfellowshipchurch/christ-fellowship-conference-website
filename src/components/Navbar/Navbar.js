    ...
    return (
        <div className='fixed-top'>
            ...
            <div className="d-flex bg-dark">
                <div className='py-3 mr-auto ml-3'><img src={brandImage} style={{height: '50px', width: '50px'}} href='#'></img></div>
                <div>{quickAction.map((link) => <h5><NavLink href={link.action} className='py-4 text-white text-uppercase font-weight-bold'>{link.call}</NavLink></h5>)}</div>
